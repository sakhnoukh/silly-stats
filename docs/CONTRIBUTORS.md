...
**Bea:**
- Built the Phase 3 extraction baseline and evolved it into stronger extractor versions (from v0 up to `extract_invoice_fields_v5.py`)
...
- Compared regex, OCR-rescue, line-classification, and NER rescue approaches and selected the strongest practical extractor version for integration into the pipeline
