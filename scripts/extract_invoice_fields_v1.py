...
class InvoiceExtractor:
    ...
    def __init__(self):
        ...
        self.amount_patterns = [
            r'(?:total\s+amount\s+due|total\s+due|amount\s+due|balance\s+due)\s*[:\-]?\s*[£$€¥₹]?\s*([\d,]+\.?\d*)',
        ...
        self._company_re = re.compile(
            r'\b(inc\.?|corp\.?|ltd\.?|llc\.?|llp\.?|co\.?|company|companies|'
            r'gmbh|ag|s\.a\.?|b\.v\.?|n\.v\.?|plc\.?|'
            ...
            r'properties|media|studio|agency|legal|attorneys?|law)\b',
            re.IGNORECASE,
        )
    ...
    def extract_invoice_number(self, text: str) -> Optional[str]:
        ...
        labeled_patterns = [
            ...
            # "Ref. No: HC-2024-3847"  "Reference: STK-INV-7741"
            r'(?:reference|ref)\.?\s*(?:no\.?|number|#)?\s*[:\-]\s*([A-Z0-9][\w\-]{2,25})',
            # "P.O. Number: 30712"
